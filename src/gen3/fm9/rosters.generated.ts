// GENERATED by scripts/gen-fm9-rosters-from-cache.ts — DO NOT EDIT BY HAND.
...
/** FM9 amp model roster (DISTORT block type selector). 331 models. */
...
/** FM9 drive/fuzz model roster (FUZZ block type selector). 86 models. */
